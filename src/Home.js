      ...
      <Router>
        <div >
            <Row className='mt-4 text-center'>
              ...
              <Button size="lg" color="info" className='mr-2'><Link className='text-white' to='/'>Homey</Link></Button>
              <Button size="lg" color="success" className='mr-2'><Link className='text-white' to='/reactstrap'>Reactstrap</Link></Button>
              <Button size="lg" color="warning" className='mr-2'><Link className='text-white' to='/ant'>Ant</Link></Button>
              <Button size="lg" color="danger"><Link className='text-white' to='/home'>Materialize</Link></Button>
              </Col>
            </Row>
